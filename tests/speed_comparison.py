...
def gen_busdaycount_1():
    cal.busdaycount(
        datetime.datetime(2009, 12, 31), datetime.datetime(2013, 12, 31)
    )
...
def gen_busdaycount_2():
    cal.busdaycount(
        datetime.datetime(2009, 12, 31), datetime.datetime(2010, 3, 1)
    )


def gen_rruleset_2():
    rr.between(
        datetime.datetime(2010, 1, 1), datetime.datetime(2010, 3, 1), inc=True
    )
...
def gen_busdaycount_3():
    cal.busdaycount(
        datetime.datetime(1969, 12, 31), datetime.datetime(2030, 12, 31)
    )
